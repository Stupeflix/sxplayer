...
const char *g_vertex_shader_data =
    "#version 330 core"                                  "\n"
...
const char *g_fragment_shader_data =
    "#version 330 core"                                  "\n"
    "in vec2 tex_coord;"                                 "\n"
    "out vec3 color;"                                    "\n"
...
static GLuint g_sampler_id = 0;
static GLuint g_vertex_buffer_id = 0;
static GLuint g_uv_buffer_id = 0;
static GLuint g_texture_id = 0;
static GLfloat g_padding = 0.0f;
